...
app_id <- 'Aprendizaje_Maquina' # el nombre que pusiste en la aplicacion
client_id<- '8913b0a55a034092b8d53fba96dd6f17' # el client id que figura en la web de spotify
client_secret <- '6c817fa6acc94f15a8688402add38e11' # el client secret que figura en la web de spotify
